...
import searchengine.services.indexing.LemmasFinder;
...
public class SearchServiceImpl implements SearchService{
    ...
    @Override
    public SearchResultResponse search(String query, String siteString, int offset, int limit) //inherit from interface?
    {
